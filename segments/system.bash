...
GAUDI_SYSTEM_CPU_COLOR="${GAUDI_SYSTEM_CPU_COLOR="$GAUDI_YELLOW"}"
GAUDI_SYSTEM_MEMORY_COLOR="${GAUDI_SYSTEM_MEMORY_COLOR="$GAUDI_MAGENTA"}"
GAUDI_SYSTEM_HDD_COLOR="${GAUDI_SYSTEM_HDD_COLOR="$GAUDI_CYAN"}"
