...
GAUDI_BATTERY_PREFIX="${GAUDI_BATTERY_PREFIX="$GAUDI_PROMPT_DEFAULT_PREFIX"}"
GAUDI_BATTERY_SUFFIX="${GAUDI_BATTERY_SUFFIX="$GAUDI_PROMPT_DEFAULT_SUFFIX"}"
...
gaudi_battery () {
  ...
  gaudi::section \
    "" \
    "$GAUDI_BATTERY_PREFIX" \
    "" \
    "$BATTERY" \
    "$GAUDI_BATTERY_SUFFIX"
}
