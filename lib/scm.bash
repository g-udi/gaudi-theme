...
[[ "${GAUDI_SCM_THEME_PROMPT_DIRTY}" == " ✕" ]] && GAUDI_SCM_THEME_PROMPT_DIRTY=' !'
[[ "${GAUDI_SCM_THEME_PROMPT_CLEAN}" == " ✓" ]] && GAUDI_SCM_THEME_PROMPT_CLEAN=''
[[ "${GAUDI_SCM_THEME_BRANCH_PREFIX}" == "\\ueafc" ]] && GAUDI_SCM_THEME_BRANCH_PREFIX=''
